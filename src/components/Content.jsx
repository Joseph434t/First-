...
export default function () {
  return (
    <div>
      <div className="grid-cols-1 md:flex mt-40">
        <div>
        ...
        <p class="mt-8 bg-black max-w-40 text-white p-5 rounded-tr-xl "><a href="" class="flex items-center gap-3">Learn more<img src={Path1} alt="" class="md:h-fit w" /></a></p>
        </div>
      </div>
    </div>
  );
