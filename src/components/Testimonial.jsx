...
export default function Testimonail () {
  return (
    <div class="h-100">
      <div class="bg-linear-to-l from-black to-yellow-500 to-35% h-1 mx-135 m-10 rounded"></div>
      <p class="text-center px-130 font-semibold text-xl">
      ...
      <div className="flex justify-center gap-60 mt-20 items-center">
        ...
        <div className="flex gap-5 bg-black py-8 px-16">
          <img src={img} alt="" className="h-12"/>
